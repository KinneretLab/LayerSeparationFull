function CreateCost_with_CLAHE(thisFileImName, inputDir, analysisDir,maskDir, z_scale, xy_scale, outputZScale,use_CLAHE, norm_window,saveDiffused)
...
% now take the smoothed image and calculate an image gradient to get the
% upper and lower surfaces
[Gmag,Gdir] = imgradient3(diffusedImage) ;
