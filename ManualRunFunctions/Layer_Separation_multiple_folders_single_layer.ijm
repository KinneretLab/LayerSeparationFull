...
topdir = "\\\\phhydra\\phhydraB\\Analysis\\users\\Yonit\\Movie_Analysis\\FEP_experiments\\";
orig_topdir = "\\\\phhydra\\TempData\\SD\\Yonit\\2020\\2020_05\\"; // Top directory where your folders are saved.
orig_dirlist = newArray("\\2020_05_26\\TIFF Files\\"+"/","\\2020_05_27\\TIFF Files\\"+"/","\\2020_05_28\\TIFF Files\\"+"/","\\2020_05_29\\TIFF Files\\"+"/");  // Insert list of folders here. "/" in the end is important for consistency with option 1.
dirlist = newArray("2020_05_26_FEP_6hr\\"+"/","2020_05_27_FEP_24hr\\"+"/","2020_05_28_FEP_48hr\\"+"/","2020_05_29_FEP_final_images\\"+"/");  // Insert list of folders here. "/" in the end is important for consistency with option 1.
...
for (j = 0; j < dirlist.length; j++){
	...
	cost_indir = topdir+dirname+"\\Layer_Separation\\Gradient_1Layer\\";
	outdir = topdir+dirname+"\\Layer_Separation\\Output_1Layer\\";
